...
export const muscularDays: WorkoutDay[] = [
  {
    id: 1,
    name: "Espalda, pecho y cuádriceps",
    focus: "Torso + piernas",
    summary:
      "Base de hipertrofia: remo, press plano y sentadilla, con trabajo de hombros y bíceps.",
    suggested: "Lunes · 50–60 min",
    exercises: [
      {
        id: "m1-row",
        name: "Remo con pecho apoyado",
        ...
        description:
          "Inclina el banco 30–45°. Apoya el pecho y lleva los codos hacia la cadera; baja con control.",
        tip: "Tus 25 lb por mancuerna son una referencia inicial, no una obligación.",
      },
      {
        id: "m1-bench",
        ...
        image: "bench-press.svg",
        description:
          "En banco plano, mantén los pies firmes. Baja las mancuernas con control y empuja hacia arriba.",
        tip: "Puedes utilizar barra libre solo con soportes seguros; empieza ligero.",
      },
      {
        id: "m1-goblet",
        name: "Sentadilla goblet",
        ...
        image: "goblet-squat.svg",
        description:
          "Sujeta una mancuerna frente al pecho o empieza sin carga; desciende a una profundidad cómoda.",
        tip: "Prioriza el equilibrio y mantén los talones apoyados.",
      },
      {
        id: "m1-shoulder",
        name: "Press de hombros sentado",
        ...
        image: "shoulder-press.svg",
        description:
          "Respaldo casi vertical; lleva las mancuernas desde los hombros hacia arriba.",
        tip: "Como vienes del press de pecho, ajusta la carga a la fatiga.",
      },
      {
        id: "m1-curl",
        name: "Curl de bíceps",
        ...
        image: "curl.svg",
        description:
          "Flexiona los codos sin balancear el cuerpo y baja lentamente.",
        tip: "Evita utilizar la espalda para impulsar las mancuernas.",
      },
    ],
  },
  {
    id: 2,
    name: "Piernas, hombros y espalda",
    focus: "Fuerza y proporción",
    summary:
      "Énfasis en cadena posterior y deltoides laterales, con remo para completar el torso.",
    suggested: "Miércoles · 50–60 min",
    exercises: [
      {
        id: "m2-rdl",
        name: "Peso muerto rumano",
        ...
        image: "rdl.svg",
        description:
          "Lleva la cadera hacia atrás con rodillas semiflexionadas y espalda neutra.",
        tip: "No necesitas llegar hasta el suelo: detente cuando pierdas la postura.",
      },
      {
        id: "m2-split",
        name: "Sentadilla dividida con apoyo",
        ...
        image: "split-squat.svg",
        description:
          "Un pie delante del otro, sujetándote de un soporte firme para equilibrarte.",
        tip: "Empieza sin mancuernas y realiza un recorrido cómodo.",
      },
      {
        id: "m2-lateral",
        name: "Elevaciones laterales",
        group: "Hombros laterales",
        sets: 3,
        reps: "12–15",
        rest: 60,
        image: "lateral-raise.svg",
        description:
          "Con mancuernas ligeras, eleva los brazos hacia los lados sin balancearte.",
        tip: "Evita encoger los hombros y no es necesario subir por encima de la altura de los hombros.",
      },
      {
        id: "m2-row",
        name: "Remo unilateral",
        ...
        image: "one-arm-row.svg",
        description:
          "Apoya una mano en el banco estable y lleva el codo hacia la cadera sin girar el torso.",
        tip: "Ambos brazos equivalen a una serie.",
      },
      {
        id: "m2-calf",
        ...
        description:
          "De pie y con apoyo estable, elévate sobre las puntas de los pies y baja con control.",
        tip: "Empieza con tu propio peso y evita rebotar.",
      },
    ],
  },
  {
    id: 3,
    name: "Espalda en V, pecho y brazos",
    focus: "Énfasis estético",
    summary:
      "Segundo estímulo de pecho y espalda, trabajo de brazos y hombro posterior, sin abandonar piernas.",
    suggested: "Viernes · 55–65 min",
    exercises: [
      {
        id: "m3-incline",
        name: "Press inclinado con mancuernas",
        ...
        image: "incline-press.svg",
        description:
          "Banco a 15–30°. Desciende con control y empuja hacia arriba.",
        tip: "No necesitas una inclinación muy alta.",
      },
      {
        id: "m3-row",
        name: "Remo con agarre neutro",
        group: "Espalda",
        sets: 3,
        reps: "10–12",
        rest: 90,
        image: "chest-row.svg",
        description:
          "Pecho apoyado en el banco inclinado, palmas enfrentadas y codos cerca del torso.",
        tip: "Mantén el tronco fijo y controla la bajada.",
      },
      {
        id: "m3-goblet",
        name: "Sentadilla goblet",
        ...
        image: "goblet-squat.svg",
        description:
          "Repite la sentadilla del lunes y progresa gradualmente si mantienes el control.",
        tip: "Puedes continuar sin peso si aún estás dominando el patrón.",
      },
      {
        id: "m3-reverse",
        name: "Aperturas inversas",
        group: "Hombro posterior · espalda alta",
        sets: 2,
        reps: "12–15",
        rest: 60,
        image: "reverse-fly.svg",
        description:
          "Pecho apoyado en banco inclinado; abre los brazos lateralmente con mancuernas ligeras.",
        tip: "No encogas los hombros ni uses impulso.",
      },
      {
        id: "m3-hammer",
        name: "Curl martillo",
        group: "Bíceps · braquial",
        sets: 2,
        reps: "10–12",
        rest: 60,
        image: "hammer-curl.svg",
        description:
          "Eleva las mancuernas con las palmas enfrentadas durante todo el recorrido.",
        tip: "Mantén los codos próximos al cuerpo.",
      },
      {
        id: "m3-triceps",
        ...
        reps: "10–15",
        rest: 60,
        image: "lying-triceps.svg",
        description:
          "Acostado en banco plano, flexiona los codos llevando mancuernas ligeras hacia los lados de la cabeza y vuelve a extender.",
        tip: "Muévete con control; si el hombro o el codo duelen, detente.",
      },
    ],
  },
];
...
export const goals: {
  ...
  {
    id: "general",
    title: "Fuerza y condición general",
    subtitle: "Rutina original",
    description:
      "Cuerpo completo equilibrado para aprender técnica, mejorar fuerza y acompañar la reducción de grasa.",
  },
  {
    id: "muscular",
...
export const daysByGoal: Record<TrainingGoal, WorkoutDay[]> = {
  general: generalDays,
  muscular: muscularDays,
};
